...
if (navigator.userAgent.includes("iPhone") || navigator.userAgent.includes("iPad")) {
    ...
    iosPrompt.style.bottom = "10px";
    iosPrompt.style.left = "10px";
    iosPrompt.style.padding = "10px";
    iosPrompt.style.backgroundColor = "#ff4500";
    iosPrompt.style.color = "white";
    iosPrompt.style.borderRadius = "5px";
    iosPrompt.innerHTML = '<p>Tocca <i class="fa fa-share"></i> e seleziona "Aggiungi alla schermata Home".</p>';
